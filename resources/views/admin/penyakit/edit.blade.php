                    ...
                    <form action="{{ route('penyakit.update' , $data->id) }}" enctype="multipart/form-data" method="post">
                     ...
                     @csrf
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" name="penyebab" value="{{ $data->penyebab }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Solusi penyakit</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" name="solusi" value="{{ $data->solusi }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Score penyakit</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="number" class="form-control" name="score" min="0" value="{{ $data->score }}">
                            </div>
                        </div>
                        {{-- <div class="form-group row mb-4">
